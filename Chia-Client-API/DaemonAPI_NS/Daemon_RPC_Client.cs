...
{
    public class DaemonRpcClient : DaemonRPCBase
    {
        private RpcClientBase _rpcClientBase;
        /// <summary>
        /// Initializes a new instance of the Daemon_RPC_Client class that can be used to interact with a Chia daemon.
        /// </summary>
        ...
        /// Preferably use on testnet or with a test daemon<br/>
        /// Any responses with potential key / authentication information are omitted</param>
        /// <param name="targetApiAddress">The IP address of the Chia daemon's RPC server. Defaults to 'localhost'.</param>
        /// <param name="targetApiPort">The port number of the Chia daemon's RPC server. Defaults to 55400.</param>
        /// <param name="targetCertificateBaseFolder">The base directory for the SSL/TLS certificate. This certificate is used to establish a secure connection with the Chia daemon's RPC server. If null, the default certificate location will be used.</param>
        /// <param name="timeout">the timeout after which the client cancels requests</param>
        /// <remarks>
        /// This constructor configures the connection details for the Chia daemon's RPC server. It is important to ensure the correctness of these details for successful communication with the daemon. 
