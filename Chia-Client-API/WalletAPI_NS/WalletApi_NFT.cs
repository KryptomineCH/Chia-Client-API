...
namespace Chia_Client_API.WalletAPI_NS
{
    public abstract partial class WalletRpcBase : ChiaEndpointRouteBase
    {
        ...
        public async Task<NftCalculateRoyalties_Response> NftCalculateRoyalties_Async(NftCalculateRoyalties_RPC rpc)
        {
            ...
            ActionResult<NftCalculateRoyalties_Response> deserializationResult = NftCalculateRoyalties_Response.LoadResponseFromString(responseJson,IncludeRawServerResponse);
        ...
        public async Task<NftCountNfts_Response> NftCountNfts_Async(WalletID_RPC rpc)
        {
            ...
            ActionResult<NftCountNfts_Response> deserializationResult = NftCountNfts_Response.LoadResponseFromString(responseJson,IncludeRawServerResponse);
        ...
        public async Task<NftGetInfo_Response> NftGetInfo_Async(NftGetInfo_RPC rpc)
        {
            ...
            ActionResult<NftGetInfo_Response> deserializationResult = NftGetInfo_Response.LoadResponseFromString(responseJson,IncludeRawServerResponse);
        ...
        public async Task<NftGetNfts_Response> NftGetNfts_Async(WalletID_RPC rpc)
        {
            ...
            ActionResult<NftGetNfts_Response> deserializationResult = NftGetNfts_Response.LoadResponseFromString(responseJson,IncludeRawServerResponse);
        ...
        public async Task<NftGetWalletsWithDIDs_Response> NftGetWalletsWithDIDs_Async()
        {
            ...
            ActionResult<NftGetWalletsWithDIDs_Response> deserializationResult = NftGetWalletsWithDIDs_Response.LoadResponseFromString(responseJson,IncludeRawServerResponse);
        ...
        public async Task<DidID_Response> NftGetWalletDID_Async(WalletID_RPC rpc)
        {
            ...
            ActionResult<DidID_Response> deserializationResult = DidID_Response.LoadResponseFromString(responseJson,IncludeRawServerResponse);
        ...
        public async Task<NftMintNFT_Response> NftMintNft_Async(NftMintNFT_RPC rpc)
        {
            ...
            ActionResult<NftMintNFT_Response> deserializationResult = NftMintNFT_Response.LoadResponseFromString(responseJson,IncludeRawServerResponse);
        ...
        public async Task<SpendBundle_MultiWallet_Response> NftSetDIDBulk_Async(NftSetDidBulk_RPC rpc)
        {
            ...
            ActionResult<SpendBundle_MultiWallet_Response> deserializationResult = SpendBundle_MultiWallet_Response.LoadResponseFromString(responseJson,IncludeRawServerResponse);
        ...
        public async Task<NftSetNftDID_Response> NftSetNftDID_Async(NftSetNftDID_RPC rpc)
        {
            ...
            ActionResult<NftSetNftDID_Response> deserializationResult = NftSetNftDID_Response.LoadResponseFromString(responseJson,IncludeRawServerResponse);
