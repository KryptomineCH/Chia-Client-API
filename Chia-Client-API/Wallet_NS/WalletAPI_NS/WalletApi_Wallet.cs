...
namespace Chia_Client_API.Wallet_NS.WalletAPI_NS
{
    public static partial class WalletApi
    {
        ...
        /// <returns></returns>
        public async static Task<GetWalletBalance_Response> GetWalletBalance_Async(WalletID_RPC walletID_RPC)
        {
        ...
        /// <returns></returns>
        public async static Task<GetTransaction_Response> GetTransaction_Async(TransactionID_RPC transactionID_RPC)
        {
        ...
        /// <param name="walletID_RPC"></param>
        /// <returns></returns>
        public async static Task<GetTransactions_Response> GetTransactions_Async(WalletID_RPC walletID_RPC)
        {
        ...
        /// <param name="walletID_RPC"></param>
        /// <returns></returns>
        public async static Task<GetTransactionCount_Response> GetTransactionCount_Async(WalletID_RPC walletID_RPC)
        {
        ...
        /// <returns></returns>
        public async static Task<GetNextAddress_Response> GetNextAddress_Async(GetNextAddress_RPC getNextAddress_RPC)
        {
        ...
        /// <returns></returns>
        public async static Task<GetTransaction_Response> SendTransaction_Async(SendXCH_RPC wallet_Send_XCH_RPC)
        {
        ...
        public async static Task<GetTransactions_Response> SendTransactionMulti_Async(SendXCH_RPC wallet_Send_XCH_RPC)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public async static Task<GetFarmedAmount_Response> GetFarmedAmount_Async()
        {
        ...
        /// </summary>
        /// <returns></returns>
        public static GetFarmedAmount_Response GetFarmedAmount_Sync()
        {
        ...
        /// <returns></returns>
        /// <exception cref="NotImplementedException"></exception>
        public async static Task<GetFarmedAmount_Response> CreateSignedTransaction_Async()
        {
        ...
        /// <returns></returns>
        /// <exception cref="NotImplementedException"></exception>
        public static GetFarmedAmount_Response CreateSignedTransaction_Sync()
        {
        ...
        /// <returns></returns>
        public async static Task<Success_Response> DeleteUnconfirmedTransactions_Async(ulong walletID)
        {
        ...
        /// <param name="walletID"></param>
        /// <returns></returns>
        public static Success_Response DeleteUnconfirmedTransactions_Sync(ulong walletID)
        {
        ...
        /// <returns></returns>
        public async static Task<SelectCoins_Response> SelectCoins_Async(SelectCoins_RPC selectCoins_RPC)
        {
        ...
        /// <param name="selectCoins_RPC"></param>
        /// <returns></returns>
        public static SelectCoins_Response SelectCoins_Sync(SelectCoins_RPC selectCoins_RPC)
        {
        ...
        /// <returns></returns>
        public async static Task<GetSpendableCoins_Response> GetSpendableCoins_Async(GetSpendableCoins_RPC getSpendableCoins_RPC)
        {
        ...
        /// <param name="getSpendableCoins_RPC"></param>
        /// <returns></returns>
        public static GetSpendableCoins_Response GetSpendableCoins_Sync(GetSpendableCoins_RPC getSpendableCoins_RPC)
        {
        ...
        /// <returns></returns>
        public async static Task<GetCoinRecordsByNames_Response> GetCoinRecordsByNames_Async(GetCoinRecordsByNames_RPC getCoinRecordsByNames_RPC)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public async static Task<GetCurrentDerivationIndec_Response> GetCurrentDerivationIndex_Async()
        {
        ...
        /// <returns></returns>
        public async static Task<ExtendDerivationIndex_Response> ExtendDerivationIndex_Async(ExtendDerivationIndex_RPC extendDerivationIndex_RPC)
        {
        ...
        /// <returns></returns>
        public async static Task<GetNotifications_Response> GetNotifications_Async(GetNotifications_RPC getNotifications_RPC = null)
        {
            string response;
        ...
        /// <returns></returns>
        public async static Task<Success_Response> DeleteNotifications_Async(DeleteNotifications_RPC deleteNotifications_RPC = null)
        {
            string response;
        ...
        /// <returns></returns>
        public async static Task<SendNotification_Response> SendNotification_Async(SendNotification_RPC sendNotification_RPC)
        {
        ...
        /// <returns></returns>
        public async static Task<SignMessage_Response> SignMessageByAddress_Async(SignMessageByAddress_RPC signMessageByAddress_RPC)
        {
        ...
        /// <returns></returns>
        public async static Task<SignMessage_Response> SignMessageByID_Async(SignMessageByID_RPC signMessageByID_RPC)
        {
        ...
        /// <returns></returns>
        /// <exception cref="NotImplementedException"></exception>
        public async static Task VerifySignature_Async(VerifySignature_RPC verifySignature_RPC)
        {
