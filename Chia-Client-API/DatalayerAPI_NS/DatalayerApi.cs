...
namespace Chia_Client_API.DatalayerAPI_NS
{
    public partial class Datalayer_RPC_Client
    {
        ...
        /// - The size of a single value flag is limited to 100 MiB.However, adding anything close to that size has not been tested and could produce unexpected results <br/>
        /// </remarks>
        /// <param name="rpc"></param>
        /// <returns></returns>
        ...
        /// This parameter is obtainable by calling the get_root RPC.</remarks>
        /// <param name="rpc"></param>
        /// <returns></returns>
        ...
        /// </summary>
        /// <remarks>This RPC does not remove any data from the database or the filesystem.</remarks>
        /// <param name="rpc"></param>
        /// <returns></returns>
        ...
        /// </summary>
        /// <remarks>For subscribed stores, this command will do nothing. Use unsubscribe and subscribe instead</remarks>
        /// <param name="rpc"></param>
        /// <returns></returns>
        ...
        /// </summary>
        /// <remarks>Note: Inherited from RPC Server</remarks>
        /// <returns></returns>
