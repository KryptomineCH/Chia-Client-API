...
namespace CHIA_API_Tests.Datalayer_NS
{
    ...
    public class Datalayer_Subscription_Tests
    {
        ...
        public void GetSubscriptions_Test()
        {
            ...
            Assert.NotNull(response.store_ids);
        ...
        public void SubscribeUnsubscribe_Test()
        {
            ...
            Assert.NotNull(subscriptionsBefore);
            Assert.True(subscriptionsBefore!.success, subscriptionsBefore.error);
            Assert.NotNull(subscriptionsBefore.store_ids);
            ...
            Assert.NotNull(subscribeResponse);
            ...
            Assert.NotNull(unsubscribeResponse);
            ...
            Assert.NotNull(subscriptionsAfter);
        ...
        public void RemoveURLFromSubscription_Test()
        {
            ...
            Assert.NotNull(removeURLResponse);
            ...
            Assert.NotNull(subscriptionMirrors);
            Assert.NotNull(subscriptionMirrors!.mirrors);
            Assert.NotEmpty(subscriptionMirrors.mirrors);
