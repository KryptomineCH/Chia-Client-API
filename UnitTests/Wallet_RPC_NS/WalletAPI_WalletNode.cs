...
namespace UnitTests.Wallet_RPC_NS
{
    ...
    public class WalletAPI_WalletNode
    {
        ...
        {
            GetNetworkInfo_Response info = WalletApi.GetNetworkInfo_Async().Result;
        ...
        {
            GetSyncStatus_Response info = WalletApi.GetSyncStatus_Async().Result;
            if (!info.success) throw new System.Exception("api call was uncucessful!");
        ...
        {
            GetHeightInfo_Response info = WalletApi.GetHeightInfo_Async().Result;
            if (!info.success) throw new System.Exception("api call was uncucessful!");
