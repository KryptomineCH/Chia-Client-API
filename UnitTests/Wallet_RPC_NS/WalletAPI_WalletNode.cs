...
namespace UnitTests.Wallet_RPC_NS
{
    ...
    public class WalletAPI_WalletNode
    {
        ...
        {
            GetNetworkInfo_Response info = Testnet.Wallet_Client.GetNetworkInfo_Async().Result;
        ...
        {
            GetHeightInfo_Response info = Testnet.Wallet_Client.GetHeightInfo_Async().Result;
            if (!info.success) throw new System.Exception("api call was uncucessful!");
