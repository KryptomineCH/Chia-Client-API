    ...
    public class Testnet_Farmer : IDisposable
    {
        static Testnet_Farmer()
        {
            ...
            string certificatePath = Path.Combine(
                ...
                ".testnet","ssl");
            Farmer_Client = new FarmerRpcClient(reportResponseErrors: false,targetApiAddress: "192.168.1.117", targetCertificateBaseFolder: certificatePath);
        }
        public static FarmerRpcClient Farmer_Client;
        public void Dispose()
        {
            // ... clean up ...
        }
